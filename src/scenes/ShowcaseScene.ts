...
export class ShowcaseScene extends Phaser.Scene {
  ...
  private addAttackDemo(x: number, y: number, attackKey: AttackType): void {
    ...
    > = {
      ...
      // ── Squirtle line ───────────────────────────────────────────────
      waterGun: { atkKey: "atk-water-range", animKey: "anim-water-range" },
      bubble: { atkKey: "atk-wave-splash", animKey: "anim-wave-splash" },
      ...
      waterPulse: { atkKey: "atk-water-pulse", animKey: "anim-water-pulse" },
