...
import type {
  EnemyConfig, Direction, SpriteConfig, EnemyRangedConfig, EnemyContactEffect,
  EnemyHealAuraConfig, EnemyDeathExplosionConfig, EnemyTeleportConfig,
...
export class Enemy extends Phaser.Physics.Arcade.Sprite {
  ...
  tryBoomerang(playerX: number, playerY: number, time: number): EnemyBoomerangConfig | null {
