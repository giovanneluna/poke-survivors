...
export const CHARMANDER_FORMS = [
  { form: 'base' as const,   name: 'Charmander',  sprite: SPRITES.charmander,  level: 1,  maxAttackSlots: 4, maxPassiveSlots: 4, passiveTier: 1 as const },
  { form: 'stage1' as const, name: 'Charmeleon',  sprite: SPRITES.charmeleon,  level: 16, maxAttackSlots: 5, maxPassiveSlots: 5, passiveTier: 2 as const },
  { form: 'stage2' as const, name: 'Charizard',   sprite: SPRITES.charizard,   level: 36, maxAttackSlots: 6, maxPassiveSlots: 6, passiveTier: 3 as const },
] as const;
