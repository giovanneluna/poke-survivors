...
export const DESTRUCTIBLES: Readonly<Record<string, DestructibleConfig>> = {
  ...
  rockSmash: {
    ...
    drops: [{ type: 'xpGem', chance: 0.3, count: 8 }, { type: 'oranBerry', chance: 0.25 }, { type: 'rareCandy', chance: 0.15 }, { type: 'pokeballBomb', chance: 0.1 }, { type: 'xpShare', chance: 0.1 }, { type: 'duplicator', chance: 0.1 }],
  },
  treasureChest: {
    key: 'treasureChest', name: 'Treasure Chest', hp: 1, textureKey: 'dest-chest', scale: 1.5,
    drops: [{ type: 'xpShare', chance: 0.15 }, { type: 'duplicator', chance: 0.15 }, { type: 'rareCandy', chance: 0.3 }, { type: 'pokeballBomb', chance: 0.2 }, { type: 'oranBerry', chance: 0.2 }],
  },
} as const;
...
export const PICKUPS: Readonly<Record<string, PickupConfig>> = {
  ...
  xpShare:      { key: 'xpShare',      name: 'XP Share',      textureKey: 'pickup-xp-share',    description: 'XP x2 pelo resto da partida!' },
  duplicator:   { key: 'duplicator',    name: 'Duplicator',    textureKey: 'pickup-duplicator',  description: '+1 projétil em todos os ataques!' },
} as const;
