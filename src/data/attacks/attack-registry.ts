...
export const ATTACKS: Readonly<Record<string, AttackConfig>> = {
  ...
  bubbleBeam:   { key: 'bubbleBeam',   name: 'Bubble Beam',   description: 'Rajada rápida com slow garantido',           baseDamage: 14, baseCooldown: 500,  element: 'water',  maxLevel: 8, minForm: 'stage1' },
