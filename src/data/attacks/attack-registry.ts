...
export const ATTACKS: Readonly<Record<string, AttackConfig>> = {
  ...
  inferno:      { key: 'inferno',      name: 'Inferno',       description: 'Bolas de fogo que explodem em AoE',         baseDamage: 48, baseCooldown: 900,  element: 'fire',   maxLevel: 8, minForm: 'stage1' },
  fireBlast:    { key: 'fireBlast',    name: 'Fire Blast',    description: 'Estrela de fogo pulsante expansiva',         baseDamage: 22, baseCooldown: 300,  element: 'fire',   maxLevel: 8, minForm: 'stage1' },
  blastBurn:    { key: 'blastBurn',    name: 'Blast Burn',    description: 'Explosão nuclear devastadora',               baseDamage: 80, baseCooldown: 3500, element: 'fire',   maxLevel: 8, minForm: 'stage2' },
  furySwipes:   { key: 'furySwipes',   name: 'Fury Swipes',   description: 'Multi-slash 360° ultra rápido',              baseDamage: 38, baseCooldown: 500,  element: 'normal', maxLevel: 8, minForm: 'stage1' },
  blazeKick:    { key: 'blazeKick',    name: 'Blaze Kick',    description: 'Chute flamejante com AoE de fogo',           baseDamage: 42, baseCooldown: 800,  element: 'fire',   maxLevel: 8, minForm: 'stage1' },
  dragonPulse:  { key: 'dragonPulse',  name: 'Dragon Pulse',  description: 'Beam dracônico que perfura tudo',            baseDamage: 52, baseCooldown: 1500, element: 'dragon', maxLevel: 8, minForm: 'stage2' },
  nightSlash:   { key: 'nightSlash',   name: 'Night Slash',   description: 'Garrada sombria, 50% crit chance',           baseDamage: 62, baseCooldown: 700,  element: 'normal', maxLevel: 8, minForm: 'stage2' },
  ...
  flareRush:    { key: 'flareRush',    name: 'Flare Rush',    description: 'Dash longo com rastro de fogo',              baseDamage: 52, baseCooldown: 2000, element: 'fire',   maxLevel: 8, minForm: 'stage1' },
  dragonRush:   { key: 'dragonRush',   name: 'Dragon Rush',   description: 'Carga dracônica com stun AoE',              baseDamage: 46, baseCooldown: 2500, element: 'dragon', maxLevel: 8, minForm: 'stage2' },
  // Charmander prime
  ...
  bubble:       { key: 'bubble',       name: 'Bubble',        description: 'Bolhas lentas multi-shot com slow',          baseDamage: 10, baseCooldown: 800,  element: 'water',  maxLevel: 8, minForm: 'base' },
  ...
  whirlpool:    { key: 'whirlpool',    name: 'Whirlpool',     description: 'Vórtice de água que prende inimigos',        baseDamage: 15, baseCooldown: 2500, element: 'water',  maxLevel: 8, minForm: 'stage1' },
  // Blastoise
  ...
  flashCannon:  { key: 'flashCannon',  name: 'Flash Cannon',  description: 'Tiro dos canhões, piercing',                 baseDamage: 28, baseCooldown: 1400, element: 'normal', maxLevel: 8, minForm: 'stage2' },
  surf:         { key: 'surf',         name: 'Surf',          description: 'Onda 360° que empurra inimigos',             baseDamage: 15, baseCooldown: 5000, element: 'water',  maxLevel: 8, minForm: 'stage2' },
  liquidation:  { key: 'liquidation',  name: 'Liquidation',   description: 'Golpe aquático 360°, reduz defesa',          baseDamage: 42, baseCooldown: 5000, element: 'water',  maxLevel: 8, minForm: 'stage2' },
  // Squirtle evoluções (baseDamage > base_attack max level)
  scald:        { key: 'scald',        name: 'Scald',         description: 'Vapor AoE ao impactar, chance de burn',      baseDamage: 48, baseCooldown: 900,  element: 'water',  maxLevel: 8, minForm: 'stage1' },
  bubbleBeam:   { key: 'bubbleBeam',   name: 'Bubble Beam',   description: 'Rajada rápida com slow garantido',           baseDamage: 40, baseCooldown: 500,  element: 'water',  maxLevel: 8, minForm: 'stage1' },
  bodySlam:     { key: 'bodySlam',     name: 'Body Slam',     description: 'Multi-slam 360°, paralisia',                 baseDamage: 38, baseCooldown: 500,  element: 'normal', maxLevel: 8, minForm: 'stage1' },
  gyroBall:     { key: 'gyroBall',     name: 'Gyro Ball',     description: 'Orbes metálicas, mais dano em inimigo lento', baseDamage: 22, baseCooldown: 300,  element: 'normal', maxLevel: 8, minForm: 'stage1' },
  waterfall:    { key: 'waterfall',    name: 'Waterfall',     description: 'Dash longo, cascata + flinch',               baseDamage: 52, baseCooldown: 2000, element: 'water',  maxLevel: 8, minForm: 'stage1' },
  originPulse:  { key: 'originPulse',  name: 'Origin Pulse',  description: 'Beam nuclear que perfura tudo',              baseDamage: 66, baseCooldown: 3500, element: 'water',  maxLevel: 8, minForm: 'stage2' },
  muddyWater:   { key: 'muddyWater',   name: 'Muddy Water',   description: 'Projéteis pesados, reduz precisão',          baseDamage: 52, baseCooldown: 1500, element: 'water',  maxLevel: 8, minForm: 'stage2' },
  crabhammer:   { key: 'crabhammer',   name: 'Crabhammer',    description: 'Garras aquáticas, 50% crit',                 baseDamage: 55, baseCooldown: 700,  element: 'water',  maxLevel: 8, minForm: 'stage2' },
